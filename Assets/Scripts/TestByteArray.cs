...
public class TestByteArray : MonoBehaviour {
	...
	void Start () {
		EzLog.Log(LogType.Debug, "This is a debug message!");
		EzLog.Log(LogType.Normal, "This is a normal message!");
		EzLog.Log(LogType.Warning, "There is something does not do as expected!");
		EzLog.Log(LogType.Error, "There is something wrong!");
